...
getStartNgrok(){
    ...
    if [[ -z "$HAS_ERRORS" ]]; then
      ...
      V_S='{"v":"2","ps":"'${REPORT_DATE}'创建，'${F_DATE}'之前停止可能提前停止","add":"0.0.0.0","port":"'${V_PORT}'","id":"'${V_UUID}'","aid":"'${V_ALTERID}'","scy":"'${V_SCY}'","net":"'ws'","type":"none","host":"${N_ADDR}","path":"","tls":"ture","sni":"","alpn":""}' 
      V_S_BAK='{"v":"2","ps":"'${REPORT_DATE}'创建，'${F_DATE}'之前停止可能提前停止","add":"'${N_ADDR}'","port":"'${N_PORT}'","id":"'${V_UUID}'","aid":"'${V_ALTERID}'","scy":"'${V_SCY}'","net":"'ws'","type":"none","host":"${N_ADDR}","path":"","tls":"ture","sni":"","alpn":""}'
      echo -e  ${V_S}"\n转\n"${V_S_BAK}"\n" >> ../result.txt
